  ...
  head: () => ({
    meta: [
      ...
      { title: "Panjharaksha Media | Post-Production Studio, Coimbatore" },
      {
        name: "description",
        content:
          "Professional recording, music production, mixing, mastering and audio post-production studio in R.S. Puram, Coimbatore.",
      },
      { name: "author", content: "Panjharaksha Media Productions" },
